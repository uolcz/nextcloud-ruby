...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Wrapper for nextcloud XML API}
  spec.description   = %q{Wrapper for nextcloud XML API - folder structure creation, etc...}
  ...
  spec.add_runtime_dependency 'net_dav', '~> 0.5'
